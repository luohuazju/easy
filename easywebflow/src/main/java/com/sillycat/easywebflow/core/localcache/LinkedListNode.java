 ...
 * into this class and only requires two reference reassignments. If remove
 * existed in the main LinkedList class, a linear scan would have to be
 * performed to find the correct node to delete.
 * <p/>
 * The linked list implementation was specifically written for the Jive cache
 * system. While it can be used as a general purpose linked list, for most
 * applications, it is more suitable to use the linked list that is part of the
 * Java Collections package.
 * 
 * @author Jive Software
 * @see com.sillycat.easywebflow.core.localcache.jivesoftware.util.LinkedList
 */
