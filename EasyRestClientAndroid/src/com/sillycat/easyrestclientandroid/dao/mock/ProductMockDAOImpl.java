...
public class ProductMockDAOImpl implements ProductDAO{
	...
	private Map<Long, Product> map = null;

	public void init(){
		if(map == null){
			map = new HashMap<Long, Product>();
	...
	public List<Product> pagination(int currentPage, int pageSize){
		...
		for(int i = start;i <= end; i++){
			pages.add(map.get(Long.valueOf(i)));
		}
		return pages;
	}
